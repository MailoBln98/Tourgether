      ...
      <nav className="navbar navbar-expand-lg navbar-dark" style={{ backgroundColor: "#23272b" }}>
        <div className="container py-4 shadow-sm">
          <div className="d-flex flex-column">
            <Link
              className="navbar-brand fs-1 fw-bold d-flex align-items-center"
              to="/"
              style={{ fontFamily: "'Oswald', 'Segoe UI', Arial, sans-serif", letterSpacing: "1px" }}
            >
              <img 
                src="/public/Tourgether_logo.png" 
                alt="Tourgether Logo" 
                className="me-3 logo-spin"
                style={{ 
                  marginTop: "1rem",
                  height: "80px", 
                  width: "auto",
            ...
            <span
              className="text-light fs-5 fst-italic ms-1"
              style={{
                marginTop: "-0.5rem",
